function listar() {
    $.get("Operador/listarOperador", function (data) {
...
$.get("Operador/listarEstado", function (data) {
...
btnBuscar.onclick = function () {
    ...
    if (idestado == "") {
        ...
        $.get("Operador/filtrarEstado/?idEstado=" + idestado, function (data) {
            crearListado(["ID", "Nombre", "Apellido", "Telefono", "Fecha de Alta"], data);
        });
}
...
function crearListado(arrayColumnas, data) {
    var contenido = "";
    contenido += "<table id='tabla-operador' class='table'>";
    contenido += "<thead>";
    contenido += "<tr>";
...
function abrirModal(id) {
    ...
    if (id == 0) {
        ...
        $.get("Operador/mostrarInfo/?id=" + id, function (data) {
...
function eliminar(id) {
    if (confirm("¿Desea eliminar el dato?") == 1) {
        $.get("Operador/eliminar/?id=" + id, function (data) {
            if (data == 0) {
